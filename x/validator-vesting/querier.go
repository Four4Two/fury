...
import (
	...
	"github.com/four4two/fury/x/validator-vesting/types"
...
func NewQuerier(bk types.BankKeeper, legacyQuerierCdc *codec.LegacyAmino) sdk.Querier {
	return func(ctx sdk.Context, path []string, req abci.RequestQuery) (res []byte, err error) {
		...
		case types.QueryCirculatingSupplyJINXY:
			return getCirculatingSupplyJINXY(ctx, req, legacyQuerierCdc)
...
func getCirculatingSupplyJINXY(ctx sdk.Context, req abci.RequestQuery, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
	// Start values
	year := 2021
	month := 8
	...
	teamJinxy := int64(4_687_500)
	treasuryJinxy := int64(5_859_375)
	monthlyStakersJinxy := int64(520_833)
	monthlyLPIncentivesJinxy := int64(2_343_750)
	...
	for i := 0; i < 23; i++ {
		scheduleAmounts = append(scheduleAmounts, []int64{0, 0, 0, monthlyStakersJinxy, monthlyLPIncentivesJinxy})
	}

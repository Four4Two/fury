...
func getCmdConvertEvmERC20ToCoin() *cobra.Command {
	return &cobra.Command{
		...
		Example: fmt.Sprintf(`
%[1]s tx %[2]s convert-evm-erc20-to-coin fury10wlnqzyss4accfqmyxwx5jy5x9nfkwh6v9rpsr 0x5FbDB2315678afecb367f032d93F642f64180aa3 1000000000000000 --from <key> --gas 1000000
`, version.AppName, types.ModuleName,
		),

...
func (suite *DelegatorRewardsTestSuite) TestAccumulateDelegatorRewards() {
	...
	testCases := []test{
		...
		},
		{
			...
			args{
				delegation:       c("ufury", 1_000_000),
				rewardsPerSecond: cs(c("jinx", 122354), c("jinxy", 567889)),
				timeElapsed:      7,
				expectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("jinx", d("0.428239000000000000")),
					types.NewRewardIndex("jinxy", d("1.987611500000000000")),
				},
			},
		},
	}
...
func (suite *DelegatorRewardsTestSuite) TestSynchronizeDelegatorReward() {
	...
	testCases := []test{
		...
		},
		{
			...
			args{
				delegation:       c("ufury", 1_000_000),
				rewardsPerSecond: cs(c("jinx", 122354), c("jinxy", 56789)),
				blockTimes:       []int{10, 10, 10, 10, 10, 10, 10, 10, 10, 10},
				expectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("jinx", d("6.117700000000000000")),
					types.NewRewardIndex("jinxy", d("2.839450000000000000")),
				},
				expectedRewards: cs(c("jinx", 6117700), c("jinxy", 2839450)),
			},
		},
	}
	for _, tc := range testCases {

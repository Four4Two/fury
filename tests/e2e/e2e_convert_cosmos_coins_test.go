...
import (
	...
	"github.com/four4two/fury/tests/e2e/testutil"
...
func setupConvertToCoinTest(
	...
	initialFunds = sdk.NewCoins(
		sdk.NewInt64Coin(suite.Fury.StakingDenom, 1e6), // gas money
...
func (suite *IntegrationTestSuite) TestConvertCosmosCoins_ERC20Magic() {
	...
	gasMoney := sdk.NewCoins(ufury(1e6))

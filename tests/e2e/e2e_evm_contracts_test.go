...
func (suite *IntegrationTestSuite) TestEthCallToErc20() {
	...
	beforeBalance := suite.Fury.GetErc20Balance(suite.DeployedErc20Address, randoReceiver)
	...
	afterBalance := suite.Fury.GetErc20Balance(suite.DeployedErc20Address, randoReceiver)
...
func (suite *IntegrationTestSuite) TestEip712ConvertToCoinAndDepositToEarn() {
	...
	balance := suite.Fury.GetErc20Balance(suite.DeployedErc20Address, depositor.EvmAddress)
